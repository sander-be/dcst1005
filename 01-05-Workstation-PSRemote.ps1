...
Copy-Item -Path "C:\Install\PowerShell-7.4.6-win-x64.msi" -Destination "C:\Install" -ToSession $session
Invoke-Command -Session $session -ScriptBlock {
    Start-Process "msiexec.exe" -ArgumentList "/i C:\Install\PowerShell-7.4.6-win-x64.msi /quiet /norestart" -Wait
}
